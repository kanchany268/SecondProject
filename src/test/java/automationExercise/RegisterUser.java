...
public class RegisterUser extends Callings {
	...
	public void entername(String name) {
		 ...
		 String message=singups.getText();
		 Assert.assertEquals(message,"New User Signup!");
	...
	driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(50));
	 ...
	 public void clickmrs() {
		 ...
		 String account=Account.getText();
			Assert.assertEquals(account,"ENTER ACCOUNT INFORMATION");
	...
	public void clickCountry() {
		...
		public void clickCreateAccount()	{
			...
			Assert.assertTrue(CreateAccount.isDisplayed()) ;
				 System.out.println("  Create Account button is display");
